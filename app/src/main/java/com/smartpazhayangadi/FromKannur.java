...
public class FromKannur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_from_kannur);
        context=this;
        s[0]="";
    ...
    public void onStart(){
        ...
        bt.execute("http://db-smartpz.rhcloud.com/script/fromkannur.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    timing[i] = new Button(FromKannur.this);
                ...
                if(s[0]=="") {
                    Toast.makeText(FromKannur.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
