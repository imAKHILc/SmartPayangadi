...
public class ToThaliparamba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_thaliparamba);
        context=this;
        s[0]="";
    ...
    public void onStart(){
        ...
        bt.execute("http://db-smartpz.rhcloud.com/script/tothaliparamba.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    timing[i] = new Button(ToThaliparamba.this);
                ...
                if(s[0]=="") {
                    Toast.makeText(ToThaliparamba.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
