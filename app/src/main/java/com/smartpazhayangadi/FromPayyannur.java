...
public class FromPayyannur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_from_payyannur);
        context=this;
        s[0]="";
    ...
    public void onStart(){
        ...
        bt.execute("http://db-smartpz.rhcloud.com/script/frompayyannur.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    timing[i] = new Button(FromPayyannur.this);
                ...
                if(s[0]=="") {
                    Toast.makeText(FromPayyannur.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
