...
public class Train_s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_s);
        context=this;
        s[0]="";
    ...
    public void onStart(){
        ...
        bt.execute("http://db-smartpz.rhcloud.com/script/train_s.php");
    }
    ...
    private class BackTask extends AsyncTask<String,Integer,Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                s_s_t = (EditText) findViewById(R.id.s_s_t);
                s_s_b = (Button) findViewById(R.id.s_s_b);
                s_s_b.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        String term;
                        term = s_s_t.getText().toString();
                        for(int i=0;i<jArray.length(); i++) {
                ...
                if(s[0]=="") {
                    Toast.makeText(Train_s.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
