...
public class ToMuttam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_muttam);
        context=this;
        s[0]="";
    ...
    public void onStart(){
        ...
        bt.execute("http://db-smartpz.rhcloud.com/script/tomuttam.php");
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                for(i=0;i<jArray.length(); i++) {
                    timing[i] = new Button(ToMuttam.this);
                ...
                if(s[0]=="") {
                    Toast.makeText(ToMuttam.this, "No Internet Access", Toast.LENGTH_SHORT).show();
                }
            }finally {
